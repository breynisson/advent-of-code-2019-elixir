defmodule Day1 do
  ...
  We start with calculating the fuel from mass.
  ...
  @doc """
  Reads the puzzle input from a .txt file and returns a
  list of integers
  """
  def read_list_of_module_mass() do
    File.read!("lib/puzzle_input.txt")
    |> String.split("\n")
  ...
  def calculate_total_fuel_requirement_for_all_modules() do
    read_list_of_module_mass()
    |> calculate_fuel_for_each_module
    |> Enum.sum()
  end
end
